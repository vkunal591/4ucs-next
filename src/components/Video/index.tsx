      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="Our team is dedicated to providing you with the right solutions, guidance, and support whenever you need it. Whether you're starting fresh, scaling your business, or looking for expert advice, we are here to assist you every step of the way."
            center
            mb="80px"
          />
        </div>
